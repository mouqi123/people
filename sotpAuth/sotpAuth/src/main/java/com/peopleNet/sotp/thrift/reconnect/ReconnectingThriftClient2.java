...
public final class ReconnectingThriftClient2 {
	private static LogUtil LOG = LogUtil.getLogger(ReconnectingThriftClient2.class);
	/**
	...
	public static <T extends TServiceClient, C> C wrap(T baseClient, Class<C> clientInterface, Options options) {
		Object proxyObject = (TServiceClient) Proxy.newProxyInstance(clientInterface.getClassLoader(),
