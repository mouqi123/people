...
public class StringUtils {
	 ...
	 * @return
	 */
	public static String[] getIncrementalStringwithEqualLength(int start, int total, int length) {
		...
		String fillStr = Integer.toString(max + 1).substring(1); // fillStr =
		// 0000...0(length个0)
	 ...
	 * @return
	 */
	public static String[] getBatchRandomStringwithEqualLength(int length, int total) {
		java.util.Random rd = new java.util.Random();
	 ...
	 * "%E4%B8%AD%E6%96%87"; System.out.println(getEncoding(str)); }
	 */
