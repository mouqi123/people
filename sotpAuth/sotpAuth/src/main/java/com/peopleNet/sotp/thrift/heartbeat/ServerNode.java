...
public class ServerNode {
	private static LogUtil log = LogUtil.getLogger(ServerNode.class);
	/** 服务ip地址 */
	private String ip;
	...
	public ServerNode() {
		log.debug("init ServerNode constructor! no args!");
	}
	...
	public ServerNode(String ip, int port) {
		super();
		log.debug("init ServerNode constructor! ip----port");
