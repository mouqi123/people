package com.people.sotp.commons.util;
    ...
    public class RandomValue {  
        ...
        private static int[] cardTypes = {1, 2};
        private static String[] banks = {"中国银行","工商银行","瑞士银行","花旗银行"};
         ...
         * 返回银行卡
         */  
        private static String[] telFirst="622141,622128,601186,601101,523036,622337,622561,843900,622848".split(",");  
        ...
        public static int randomCardType() {
        	return cardTypes[(int)(Math.random()*2)];
        }
