...
public class AlidayuNote {
	...
	public static  boolean sendNoteCode(String phoneNum,String code,String module){
		...
		req.setSmsParamString("{\"code\":\""+code+"\",\"module\":\""+module+"\"}");
		req.setRecNum(phoneNum);
		req.setSmsTemplateCode("SMS_12240498");
